  ...
  if(ARG_USES_PNG)
    ...
    if(ARG_USES_ICU)
      if (ANDROID)
        ...
        target_link_libraries(${NAME} -Wl,--whole-archive ${ICU_LIBRARIES} -Wl,--no-whole-archive)
      else ()
    ...
    if (ANDROID)
      ...
      target_link_libraries(${NAME} ${SAFFAL_LIBRARY} ${GLOB_LIBRARY} log AndroidGraphicsLayer)
    endif ()
...
if (ANDROID)
function(wl_shared_library NAME)
  _parse_common_args("${ARGN}")
